...
int main()
{
    ...
    TransitionFunction<char> e(secondState, thirdState, 'a');
    TransitionFunction<char> f(secondState, initialState, 'b');

    TransitionFunction<char> g(thirdState, firstState, 'a');
    TransitionFunction<char> h(thirdState, secondState, 'b');

    Automata<char> fsm({ initialState, firstState, secondState, thirdState }, { a,b,c,d,e,f,g,h }, {'a','b'}, initialState);

    std::string parsedString = "abbbbababbb";
